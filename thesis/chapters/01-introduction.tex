...
The author works as a Machine Learning Integration Engineer at OneRail, building LLM-powered support workflows for same-day logistics. Observed gains in agent productivity from LLM assistance motivated evaluating SCoTD as a low-cost way to increase reasoning accuracy under practical constraints (latency, cost, and single-GPU hardware).

\section*{Thesis outline}
Chapter~2 summarizes background on CoT, distillation, PEFT/QLoRA, tokenization, prompting, and GSM8K. Chapter~3 reviews related work on CoT prompting and small-model enhancement. Chapter~4 details the methodology and training setups. Chapter~5 describes the experimental setup. Chapter~6 presents results and analyses. Chapter~7 discusses implications and limitations. Chapter~8 concludes with practical guidance. Chapters~9--11 cover ethics, licensing, and reproducibility, with appendices for supplementary materials.
