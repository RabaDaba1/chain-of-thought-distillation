...
\begin{itemize}
    ...
    \item No exploration of self-consistency decoding \cite{wang2023selfconsistencyimproveschainthought}; potential additive gains remain unmeasured.
...
\begin{itemize}
    ...
    \item Parameter-efficient fine-tuning (LoRA + QLoRA) is sufficient to encode reasoning gains on a single consumer-grade 24\,GB GPU.
